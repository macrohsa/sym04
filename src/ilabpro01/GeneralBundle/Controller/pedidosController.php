...
use ilabpro01\GeneralBundle\Entity\pedidos;
use ilabpro01\GeneralBundle\Form\pedidosType;
...
class pedidosController extends Controller
{
     ...
     * @Method("POST")
     * @Template("ilabpro01GeneralBundle:pedidos:new.html.twig")
     */
    public function createAction(Request $request)
    {
        $entity  = new pedidos();
        $form = $this->createForm(new pedidosType(), $entity);
        $form->bind($request);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ilabpro01GeneralBundle:pedidos')->find($id);
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new pedidosType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
     ...
     * @Method("PUT")
     * @Template("ilabpro01GeneralBundle:pedidos:edit.html.twig")
     */
